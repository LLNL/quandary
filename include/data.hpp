...
class Data{
  protected:
	...
	public:
    Data();
    Data(Config config, MPI_Comm comm_optim, std::vector<std::string>& data_name, std::vector<int> nlevels, LindbladType lindbladtype);
    virtual ~Data();
...
class SyntheticRhoQuandaryData : public Data {
  public:
    SyntheticRhoQuandaryData (Config config, MPI_Comm comm_optim, std::vector<std::string>& data_name, std::vector<int> nlevels, LindbladType lindbladtype);
...
class Tant2levelData : public Data {
  ...
  public:
    Tant2levelData(Config config, MPI_Comm comm_optim, std::vector<std::string>& data_name, std::vector<int> nlevels, LindbladType lindbladtype);
    ~Tant2levelData();
...
class Tant3levelData : public Data {
  ...
  public:
    Tant3levelData(Config config, MPI_Comm comm_optim, std::vector<std::string>& data_name,  std::vector<int> nlevels, LindbladType lindbladtype);
    ~Tant3levelData();
