...
class Data{
  protected:
	...
	public:
    Data();
    Data(Config config, MPI_Comm comm_optim_, MPI_Comm comm_init_, int ninit_, std::vector<int> nlevels_, LindbladType lindbladtype_);
    virtual ~Data();
    ...
    /* Loads data and sets first and last time point as well as sampling */
    // Synthetic Quandary data for density matrices
