...
class Output{
  ...
  public:
    ...
    void writeOptimFile(double objective, double gnorm, double stepsize, double Favg, double cost, double tikh_regul,  double penalty, double penalty_dpdm, double penalty_energy, double interm_discontinuity);
