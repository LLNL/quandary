...
class PythonInterface{
  ...
  void receiveTransfer(int noscillators,std::vector<std::vector<fitpackpp::BSplineCurve*>>& transfer_func_re, std::vector<std::vector<fitpackpp::BSplineCurve*>>& transfer_func_im);
};
