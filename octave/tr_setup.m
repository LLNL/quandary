...
# 6x4 case, Nguard=2, 5 freq x 5 wavelets = 25 param, new initial guess
  ...
  # 6x4 case, Nguard=2, 5 freq x 6 wavelets = 30 param, new case; tp=T/10 and new scaling between gate and guard levels. Final gate fidelity = 9.999873e-01, norm2 of guard levels = 5.558054e-05
