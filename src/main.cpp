...
int main(int argc,char **argv)
{
  ...
  OptimProblem optimproblem(primalbraidapp, adjointbraidapp, comm_hiop, optimbounds, config.GetDoubleParam("optim_regul", 1e-4), config.GetStrParam("optim_x0filename", "none"), config.GetBoolParam("optim_diagonly", false), config.GetStrParam("datadir", "./data_out"));
